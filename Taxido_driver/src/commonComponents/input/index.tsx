...
export function Input({ placeholder, keyboardType, value, warning, onChangeText, showWarning, icon, titleShow, title, backgroundColor, rightIcon, onPress, secureText, borderColor, editable, }: InputProps) {
